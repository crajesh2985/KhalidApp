...
public class RadioTaskListAdapter extends RecyclerView.Adapter<RadioTaskListAdapter.ViewHolder> {

    ArrayList<TaskListBean> taskListBeen;

    public RadioTaskListAdapter(List<TaskListBean> taskListBeen) {
        this.taskListBeen = new ArrayList<>(taskListBeen);
    }

    @Override
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.adapter_radio_list_view, parent, false);
